...
public class MockupRenewableChargeConfiguration implements IRenewableChargeConfiguration {
    ...
    private void loadConfig() {
        ...
        energyTypes.add(new EnergyType("solar", 0.5F, 20000, solarEvents, "solar.png"));
        energyTypes.add(new EnergyType("water", 0.5F, 40000, waterEvents, "water.png"));
        ...
        players.add(new Player(player1Rfid, "player1", false, I2CButton.YELLOW, 0));
        players.add(new Player(player2Rfid, "player2", false, I2CButton.BLUE, 0));
        players.add(new Player("3", "player3", false, I2CButton.GREEN, 0));
        players.add(new Player("4", "player4", false, I2CButton.RED, 0));
